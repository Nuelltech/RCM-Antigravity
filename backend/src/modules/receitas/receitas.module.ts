...
const createRecipeSchema = z.object({
    ...
    tempo_preparacao: z.number().int().optional().nullable(),
    quantidade_total_produzida: z.number().min(0).optional().nullable(),
    unidade_medida: z.enum(['KG', 'L', 'Unidade']).optional(),
    tipo: z.enum(['Final', 'Pre-preparo']),
    descricao: z.string().optional().nullable(),
    imagem_url: z.string().url().optional().or(z.literal('')).nullable(),
