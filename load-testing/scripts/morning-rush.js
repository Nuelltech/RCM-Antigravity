...
// Morning rush pattern: Normal → Spike → Sustained → Return
...
console.log(`📊 User pool: ${users.length} users across ${tenants.length} tenants`);
...
export function handleSummary(data) {
    console.log('');
    console.log('🌅 Morning Rush Test Summary');
    console.log('========================================');
    ...
    if (p95 < 500) {
        console.log('✅ PASS: p95 < 500ms during peak load');
    } else {
        console.log(`❌ FAIL: p95 (${p95}ms) exceeded 500ms target`);
    }

    if (p99 < 1000) {
        console.log('✅ PASS: p99 < 1s during peak load');
    } else {
        console.log(`❌ FAIL: p99 (${p99}ms) exceeded 1s target`);
    }
